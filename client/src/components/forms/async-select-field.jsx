...
export const AsyncSelectField = ({service, getData, labelKeys, name, readOnly, value, onChange}) => {
    ...
    if(readOnly) {
        return (
            <Form.Control readOnly plaintext value={options[optionValues.indexOf(value)]}/>
        )
    }
    return (
